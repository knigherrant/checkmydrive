...
include_once (dirname(__FILE__) . '/form/helper.php');
include_once (dirname(__FILE__) . '/form/field.php');
include_once (dirname(__FILE__) . '/form/rule.php');
include_once (dirname(__FILE__) . '/form/html.php');
class Form{
