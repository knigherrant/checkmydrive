...
abstract class JHtmlBatch
{
	...
	public static function access()
	{
		...
		return
			...
			. Checkmydrive::_('JLIB_HTML_BATCH_ACCESS_LABEL')
			. '</label>'
			. JHtml::_(
				...
				'class="inputbox"',
				array(
					'title' => Checkmydrive::_('JLIB_HTML_BATCH_NOCHANGE'),
					'id' => 'batch-access'
				)
			);
	}
	...
	public static function item($extension)
	{
		...
		$options = array(
			JHtml::_('select.option', 'c', Checkmydrive::_('JLIB_HTML_BATCH_COPY')),
			JHtml::_('select.option', 'm', Checkmydrive::_('JLIB_HTML_BATCH_MOVE'))
		);

		// Create the batch selector to change select the category by which to move or copy.
		return
			'<label id="batch-choose-action-lbl" for="batch-choose-action">' . Checkmydrive::_('JLIB_HTML_BATCH_MENU_LABEL') . '</label>'
			. '<div id="batch-choose-action" class="control-group">'
			. '<select name="batch[category_id]" class="inputbox" id="batch-category-id">'
			. '<option value="">' . Checkmydrive::_('JSELECT') . '</option>'
	...
	public static function language()
	{
		...
		return
			...
			. Checkmydrive::_('JLIB_HTML_BATCH_LANGUAGE_LABEL')
			. '</label>'
			. '<select name="batch[language_id]" class="inputbox" id="batch-language-id">'
			. '<option value="">' . Checkmydrive::_('JLIB_HTML_BATCH_LANGUAGE_NOCHANGE') . '</option>'
	...
	public static function user($noUser = true)
	{
		...
		if ($noUser)
		{
			$optionNo = '<option value="0">' . Checkmydrive::_('JLIB_HTML_BATCH_USER_NOUSER') . '</option>';
		}
		...
		return
			...
			. Checkmydrive::_('JLIB_HTML_BATCH_USER_LABEL')
			. '</label>'
			. '<select name="batch[user_id]" class="inputbox" id="batch-user-id">'
			. '<option value="">' . Checkmydrive::_('JLIB_HTML_BATCH_USER_NOCHANGE') . '</option>'
			. $optionNo
	...
	public static function tag()
	{
		...
		return
			...
			. Checkmydrive::_('JLIB_HTML_BATCH_TAG_LABEL')
			. '</label>'
			. '<select name="batch[tag]" class="inputbox" id="batch-tag-id">'
			. '<option value="">' . Checkmydrive::_('JLIB_HTML_BATCH_TAG_NOCHANGE') . '</option>'
