...
abstract class JHtmlFormbehavior
{
	...
	public static function chosen($selector = '.advancedSelect', $debug = null, $options = array())
	{
		...
		$options['placeholder_text_multiple'] = isset($options['placeholder_text_multiple']) ? $options['placeholder_text_multiple']: Checkmydrive::_('JGLOBAL_SELECT_SOME_OPTIONS');
		$options['placeholder_text_single']   = isset($options['placeholder_text_single']) ? $options['placeholder_text_single'] : Checkmydrive::_('JGLOBAL_SELECT_AN_OPTION');
		$options['no_results_text']           = isset($options['no_results_text']) ? $options['no_results_text'] : Checkmydrive::_('JGLOBAL_SELECT_NO_RESULTS_MATCH');
	...
	public static function ajaxchosen(JRegistry $options, $debug = null)
	{
		...
		Checkmydrive::script('JGLOBAL_KEEP_TYPING');
		Checkmydrive::script('JGLOBAL_LOOKING_FOR');
