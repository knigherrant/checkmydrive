...
abstract class JHtmlDropdown
{
	...
	public static function edit($id, $prefix = '', $customLink = '')
	{
		...
		$link = Checkmydrive::route($link);

		static::addCustomItem(Checkmydrive::_('JACTION_EDIT'), $link);
	...
	{
		$task = $prefix . 'publish';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_PUBLISH'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	public static function unpublish($checkboxId, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_UNPUBLISH'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	public static function featured($checkboxId, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JFEATURED'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	public static function unfeatured($checkboxId, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JUNFEATURED'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	{
		$task = $prefix . 'archive';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_ARCHIVE'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	{
		$task = $prefix . 'unpublish';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_UNARCHIVE'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	{
		$task = $prefix . 'trash';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_TRASH'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	{
		$task = $prefix . 'publish';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_UNTRASH'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
	...
	{
		$task = $prefix . 'checkin';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_CHECKIN'), 'javascript:void(0)', 'onclick="contextAction(\'' . $checkboxId . '\', \'' . $task . '\')"');
