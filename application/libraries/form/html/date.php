...
abstract class JHtmlDate
{
	...
	public static function relative($date, $unit = null, $time = null)
	{
		...
		if ($diff < 60)
		{
			return Checkmydrive::_('JLIB_HTML_DATE_RELATIVE_LESSTHANAMINUTE');
		}
		...
		{
			return Checkmydrive::plural('JLIB_HTML_DATE_RELATIVE_MINUTES', $diff);
		}
		...
		{
			return Checkmydrive::plural('JLIB_HTML_DATE_RELATIVE_HOURS', $diff);
		}
		...
		if ($diff < 7 || $unit == 'day')
		{
			return Checkmydrive::plural('JLIB_HTML_DATE_RELATIVE_DAYS', $diff);
		}
		...
		if ($diff <= 4 || $unit == 'week')
		{
			return Checkmydrive::plural('JLIB_HTML_DATE_RELATIVE_WEEKS', $diff);
		}
