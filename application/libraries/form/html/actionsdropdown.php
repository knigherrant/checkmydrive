...
abstract class JHtmlActionsDropdown
{
	...
	public static function render($item = '')
	{
		...
		if ($item)
		{
			$html[] = '<span class="element-invisible">' . Checkmydrive::sprintf('JACTIONS', $item) . '</span>';
		}
	...
	public static function publish($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_PUBLISH'), 'publish', $id, $task);
	}
	...
	public static function unpublish($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_UNPUBLISH'), 'unpublish', $id, $task);
	}
	...
	public static function feature($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JFEATURE'), 'featured', $id, $task);
	}
	...
	public static function unfeature($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JUNFEATURE'), 'unfeatured', $id, $task);
	}
	...
	public static function archive($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_ARCHIVE'), 'archive', $id, $task);
	}
	...
	{
		$task = ($prefix ? $prefix . '.' : '') . 'unpublish';
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_UNARCHIVE'), 'unarchive', $id, $task);
	}
	...
	public static function duplicate($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_DUPLICATE'), 'copy', $id, $task);
	}
	...
	public static function trash($id, $prefix = '')
	{
		...
		static::addCustomItem(Checkmydrive::_('JTOOLBAR_TRASH'), 'trash', $id, $task);
	}
