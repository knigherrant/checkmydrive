...
abstract class JHtmlBehavior
{
	...
	public static function formvalidation()
	{
		...
		Checkmydrive::script('JLIB_FORM_FIELD_INVALID');
	...
	public static function calendar()
	{
		...
		Checkmydrive::calendar();

		$translation = static::calendartranslation();

		if ($translation)
		{
			Checkmydrive::addScript($translation);
		}
	...
	protected static function calendartranslation()
	{
		...
		// To keep the code simple here, run strings through Checkmydrive::_() using array_map()
		$callback = array('Checkmydrive','_');
		...
		$today = " " . Checkmydrive::_('JLIB_HTML_BEHAVIOR_TODAY') . " ";
		$text = array(
			'INFO'			=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_ABOUT_THE_CALENDAR'),
			...
			'ABOUT'			=> "DHTML Date/Time Selector\n"
				...
				. "\n\n"
				. Checkmydrive::_('JLIB_HTML_BEHAVIOR_DATE_SELECTION')
				. Checkmydrive::_('JLIB_HTML_BEHAVIOR_YEAR_SELECT')
				. Checkmydrive::_('JLIB_HTML_BEHAVIOR_MONTH_SELECT')
				. Checkmydrive::_('JLIB_HTML_BEHAVIOR_HOLD_MOUSE'),
			...
			'PREV_YEAR'		=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_PREV_YEAR_HOLD_FOR_MENU'),
			'PREV_MONTH'	=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_PREV_MONTH_HOLD_FOR_MENU'),
			'GO_TODAY'		=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_GO_TODAY'),
			'NEXT_MONTH'	=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_NEXT_MONTH_HOLD_FOR_MENU'),
			'SEL_DATE'		=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_SELECT_DATE'),
			'DRAG_TO_MOVE'	=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_DRAG_TO_MOVE'),
			'PART_TODAY'	=> $today,
			'DAY_FIRST'		=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_DISPLAY_S_FIRST'),
			'WEEKEND'		=> Checkmydrive::_('WEEKEND'),
			'CLOSE'			=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_CLOSE'),
			'TODAY'			=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_TODAY'),
			'TIME_PART'		=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_SHIFT_CLICK_OR_DRAG_TO_CHANGE_VALUE'),
			'DEF_DATE_FORMAT'	=> "%Y-%m-%d",
			'TT_DATE_FORMAT'	=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_TT_DATE_FORMAT'),
			'WK'			=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_WK'),
			'TIME'			=> Checkmydrive::_('JLIB_HTML_BEHAVIOR_TIME')
		);
