...
abstract class JFormField
{
	...
	protected function getTitle()
	{
		...
		$title = $this->translateLabel ? Checkmydrive::_($title) : $title;
	...
	protected function getLabel()
	{
		...
		$text = $this->translateLabel ? Checkmydrive::_($text) : $text;
		...
		if (!empty($this->description))
		{
			...
			$description = $this->translateDescription ? Checkmydrive::_($this->description) : $this->description;
