...
abstract class JHtml
{
	...
	public static function _($key)
	{
		...
		{
			$path = JFolder::find(static::$includePaths, strtolower($file) . '.php');
	...
	{
            if($input =='now') return Checkmydrive::getDate()->toSql;
            return $input;
	...
	public static function addIncludePath($path = '')
	{
		...
		foreach ($path as $dir)
		{
			...
			{
				array_unshift(static::$includePaths, JFolder::clean($dir));
			}
		}
