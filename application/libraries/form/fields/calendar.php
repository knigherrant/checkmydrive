...
class JFormFieldCalendar extends JFormField
{
	...
	protected function getInput()
	{
		...
		$hint = $this->translateHint ? Checkmydrive::_($this->hint) : $this->hint;
		...
		if (strtoupper($this->value) == 'NOW')
		{
			$this->value = strftime($format);
                ...
                Checkmydrive::addScript('jQuery(function($){ $("#'.$this->id.'").datepicker({autoclose: true}); })');
                ob_start();
                if(!$this->value) $this->value = Checkmydrive::getDate('now', false, 'Y-m-d')->toFormat;
                ?>
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" id="<?php echo $this->id; ?>" name="<?php echo $this->name; ?>" value="<?php echo $this->value; ?>" class="form-control">
                    </div>
                <?php
                return ob_get_clean();
	}
