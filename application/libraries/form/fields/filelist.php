...
class JFormFieldFileList extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		if (!$this->hideNone)
		{
			$options[] = JHtml::_('select.option', '-1', Checkmydrive::_('JOPTION_DO_NOT_USE', preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->fieldname)));
		}

		if (!$this->hideDefault)
		{
			$options[] = JHtml::_('select.option', '', Checkmydrive::_('JOPTION_USE_DEFAULT', preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->fieldname)));
		}
