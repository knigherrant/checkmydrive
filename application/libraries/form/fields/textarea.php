...
class JFormFieldTextarea extends JFormField
{
	...
	protected function getInput()
	{
		...
		$hint = $this->translateHint ? Checkmydrive::_($this->hint) : $this->hint;
                ...
                if((string) $this->element->attributes()->editor == true ) $this->class .= 'mce_editable';
                
                $attr = array();
                if($width = (string) $this->element->attributes()->width ){
                    $attr[] = "width:$width";
                }
                if($height = (string) $this->element->attributes()->height ){
                    $attr[] = "height:$height";
                }
                $style = '';
                if($attr) $style = 'style="' . implode (';', $attr) . '"';
		...
		return '<textarea name="' . $this->name . '" id="' . $this->id . '"' . $columns . $rows . $class . $style
