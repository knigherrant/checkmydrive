...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo Checkmydrive::route('login'); ?>" style="color: #3366cc;">Go to <?php echo $site_name; ?> now!</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?php echo Checkmydrive::route('login'); ?>" style="color: #3366cc;"><?php echo Checkmydrive::route('login'); ?></a></nobr><br />
<br />
<br />
Your username: <?php echo $email; ?><br />
